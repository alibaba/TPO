...
def eval_model(args):
    ...
    with open(os.path.expanduser(args.question_file), "r") as f_qs:
        questions = json.load(f_qs)
    
    #questions = [json.loads(q) for q in open(os.path.expanduser(args.question_file), "r")] # for jsonl file 
    ...
    for (input_ids, image_tensor, image_sizes), line in tqdm(zip(data_loader, questions), total=len(questions)):
        ...
        ans_file.write(json.dumps({"category": category,
